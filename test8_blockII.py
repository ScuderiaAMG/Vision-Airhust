...
#     model_path = "/home/legion/Vision-Airhust/yolov8x.pt"
#     if not os.path.exists(model_path):
#         print(f"Warning: {model_path} not found, searching for alternatives...")
#         for f in os.listdir("."):
#             if "yolov8x" in f.lower() and f.endswith(".pt"):
#                 model_path = f
#                 print(f"Found alternative model: {model_path}")
#                 break
#         else:
#             print("No YOLOv8x model found, using YOLOv8x.yaml")
#             model_path = "yolov8x.yaml"
#     try:
#         model = YOLO(model_path)
#         if "yolov8x" not in str(model.model):
#             print("Warning: Loaded model is not YOLOv8x! Forcing reload...")
#             model = YOLO("yolov8x.yaml")
#         print(f"Model architecture: {model.model.names}")
